...
package com.github.shannah.testcn111;
 ...
 * @author Shai Almog
 */
public class TestCn111Stub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Test Cn111";
    private static final String APP_NAME = "test-cn111";
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new TestCn111Stub());
    }
